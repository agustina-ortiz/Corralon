        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto p-4 sidebar-scroll">
                <div class="space-y-2">
                    ...
                    <!-- Estadísticas -->
                    @if($u->tieneAccesoAModulo('insumos') || $u->tieneAccesoAModulo('maquinarias') || $u->tieneAccesoAModulo('vehiculos') || $u->tieneAccesoAModulo('movimientos_insumos') || $u->tieneAccesoAModulo('choferes') || $u->tieneAccesoAModulo('eventos'))
                    <a href="{{ route('estadisticas') }}"
                       wire:navigate
                       @click="sidebarOpen = false"
                       class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 {{ request()->routeIs('estadisticas') ? 'bg-custom-green' : 'hover-custom-green hover:bg-gray-600' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-4">
                        ...
                        <div class="mt-2 space-y-1">
                            ...
                            <a href="{{ route('choferes') }}"
                                wire:navigate
                                @click="sidebarOpen = false"
                               class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200 {{ request()->routeIs('choferes') ? 'bg-custom-green' : 'hover-custom-green hover:bg-gray-600' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zm10 0a2 2 0 11-4 0 2 2 0 014 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h11v12H3z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 9h4l3 3v5h-7V9z"/>
