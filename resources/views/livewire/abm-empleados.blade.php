            ...
            <table class="min-w-full divide-y divide-gray-100">
                <thead class="bg-gradient-to-r from-gray-50 to-gray-100/50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Apellido</th>
                ...
                <tbody class="bg-white divide-y divide-gray-50">
                    @forelse ($empleados as $empleado)
                        <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900">{{ $empleado->apellido }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-600">{{ $empleado->nombre }}</div>
                            </td>
                        ...
                        <div class="bg-white px-6 pt-6 pb-5">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    >
                                    @error('legajo') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                                </div>
